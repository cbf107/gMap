<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GridViewUI.ascx.cs" Inherits="BaseWebAppication.Controls.GridViewUI" %>

<script type="text/javascript">
    function openOpen(){
       //window.open("<%=editPage%>","newwindow","width=<%=dialogWidth%>,height=<%=dialogHeight %>,top=<%=dialogLeft %>,left=<%=dialogTop %>,resizable=yes");
...
<div>
    ...
    <span>
    <asp:LinkButton ID="BtnDelete" runat="server" onclick="BtnDelete_Click" OnClientClick=" return confirm('确定删除?');">删除信息</asp:LinkButton>
    </span> 
    <span>
    每页显示
